...
public class UpdateSimplificationMacro extends AbstractPropositionalExpansionMacro {
    ...
    private static final String[] ADMITTED_RULE_NAMES =
        { "simplifyUpdate1", "simplifyUpdate2", "simplifyUpdate3", "simplifyMutatingUpdate1",
            "simplifyMutatingUpdate2", "simplifyMutatingUpdate3", "sequentialToParallel1",
            "sequentialToParallel2", "sequentialToParallel3", "applyOnRigidTerm",
            "applyOnRigidFormula", "applyOnElementary", "applyOnMutating", "applyMutating",
            "applyOnParallel", "applyOnSkip",
